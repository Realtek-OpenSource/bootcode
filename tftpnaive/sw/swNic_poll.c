...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/boot0412/tftpnaive/sw/swNic_poll.c,v 1.4 2012/11/14 07:48:54 tctsai Exp $
*
...
*
* $Log: swNic_poll.c,v $
* Revision 1.4  2012/11/14 07:48:54  tctsai
* Review the compiler warning.
*
* Modified Files:
* boot/main.c
*
* loader/amd29LvMtd.c 		loader/cmd.c 			loader/gpio.c
* loader/help.h 			loader/loader.c 		loader/rtl8672_asicregs.h
* loader/rtprintf.c 		loader/spi_flash.c 		loader/uart.h
*
* tcp/http.c			tcp/http.h 			tcp/ip.c
* tcp/mem.h 			tcp/tcp_input.c 		tcp/tcp_output.c
*
* tftpnaive/bootp.c 		tftpnaive/net.c 		tftpnaive/re8670poll.c
* tftpnaive/re8670poll.h 		tftpnaive/tftpnaive.h 		tftpnaive/udp.c
* tftpnaive/rtl8367b/rtk_api.h 	tftpnaive/sw/swNic_poll.c	tftpnaive/sw/vlanTable.c
*
* tftpnaive/sw/include/rtl_types.h
* tftpnaive/sw/include/rtl8650/asicregs.h
*
* zlib/inflate.c			zlib/zlib.h 			zlib/zutil.h
*
...
//   uint8      ph_ptp_flags;	// only valid @NIC-TX :
   uint8      ph_ptpResv:1;
...
//	if(switch_debug_msg==1)
    ...
    ASSERT_CSP( ((int32) txPkthdrRing[USED_TX_RING][currTxPkthdrDescIndex] & DESC_OWNED_BIT) == DESC_RISC_OWNED );

    /* Fetch packet header from Tx ring */
    pPkthdr = (struct pktHdr *) ((int32) txPkthdrRing[USED_TX_RING][currTxPkthdrDescIndex] 
                                                & ~(DESC_OWNED_BIT | DESC_WRAP));
...
void swNic_txDone(void)
{
	...
	while (txPktDoneDescIndex != currTxPkthdrDescIndex) {		
	    if ( (*(volatile uint32 *)&txPkthdrRing[USED_TX_RING][txPktDoneDescIndex] 
                    & DESC_OWNED_BIT) == DESC_RISC_OWNED ) 
            {										
		    pPkthdr = (struct pktHdr *) ((int32) txPkthdrRing[USED_TX_RING][txPktDoneDescIndex] 
                                                & ~(DESC_OWNED_BIT | DESC_WRAP));
...
void swInit(char* mac){
    ...
    uint32 rx[6] = {NUM_RX_PKTHDR_DESC, 0, 0, 0, 0, 0};
