...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/boot0412/tftpnaive/sw/include/rtl8650/asicregs.h,v 1.4 2012/11/14 07:48:54 tctsai Exp $
*
...
/* Serdes
*/
#define SERDES_BASE			0xBC000000
#define SERDES_ADDR0			(SERDES_BASE + 0x200)
#define SERDES_ADDR1			(SERDES_BASE + 0x210)
#define SERDES_ADDR2			(SERDES_BASE + 0x220)
#define SERDES_ADDR3			(SERDES_BASE + 0x230)
#define SERDES_ADDR4			(SERDES_BASE + 0x240)
#define SERDES_ADDR5			(SERDES_BASE + 0x250)

#define SDS_Nway_Status		0xB8000640
	#define EN_EEE_GIGA		(1 << 11)
	#define EN_EEE_100		(1 << 10)
	#define NWAY_FAULT		(1 << 9)
	#define MASTER_MODE		(1 << 8)
	#define EN_NWAY			(1 << 7)
	#define EN_TXFLOW		(1 << 6)
	#define EN_RXFLOW		(1 << 5)
	#define LINK_OK			(1 << 4)
	#define FIBER_MODE		(1 << 3)
	#define FULL_DUPLEX		(1 << 2)
	#define SPD_MASK			(3 << 0)
	#define SPD_10M			(0 << 0)
	#define SPD_100M			(1 << 0)
	#define SPD_1000M		(2 << 0)

#define SDSP0_Status			(SDS_Nway_Status + 0x00)
#define SDSP1_Status			(SDS_Nway_Status + 0x02)
#define SDSP2_Status			(SDS_Nway_Status + 0x04)
#define SDSP3_Status			(SDS_Nway_Status + 0x06)
