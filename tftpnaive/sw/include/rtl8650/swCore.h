...
* All rights reserved.
* 
* $Header: /usr/local/dslrepos/boot0412/tftpnaive/sw/include/rtl8650/swCore.h,v 1.2 2011/09/08 09:49:36 cathy Exp $
*
...
typedef struct SerdesStatus_s{
	uint16 rsv:4;
	uint16 en_eee_giga:1;
	uint16 en_eee_100:1;
	uint16 nway_fault:1;
	uint16 mastar_mode:1;
	uint16 en_nway:1;
	uint16 en_txflow:1;
	uint16 en_rxflow:1;
	uint16 link_ok:1;
	uint16 fiber_mode:1;
	uint16 full_duplex:1;
	uint16 spd:2;
}SerdesStatus_t;


#define mdelay delay_msec
