...
#define NAND_MODEL_NUM_BLK_512          ((512/UNIT_NUM_BLK)-1)
#define NAND_MODEL_NUM_BLK_1024         ((1024/UNIT_NUM_BLK)-1)
#define NAND_MODEL_NUM_BLK_2048         ((2048/UNIT_NUM_BLK)-1)
#define NAND_MODEL_NUM_PAGE_32          ((32/UNIT_NUM_PAGE)-1)
#define NAND_MODEL_NUM_PAGE_64          ((64/UNIT_NUM_PAGE)-1)
#define NAND_MODEL_NUM_PAGE_128         ((128/UNIT_NUM_PAGE)-1)
#define NAND_MODEL_PAGE_SIZE_1024B      ((1024/UNIT_PAGE_SIZE)-1)
#define NAND_MODEL_PAGE_SIZE_2048B      ((2048/UNIT_PAGE_SIZE)-1)
#define NAND_MODEL_PAGE_SIZE_4096B      ((4096/UNIT_PAGE_SIZE)-1)
#define NAND_MODEL_SPARE_SIZE_64B       ((64/UNIT_SPARE_SIZE)-1)
#define NAND_MODEL_SPARE_SIZE_128B      ((128/UNIT_SPARE_SIZE)-1)
#define NAND_MODEL_SPARE_SIZE_256B      ((256/UNIT_SPARE_SIZE)-1)
#define NAND_MODEL_OOB_SIZE(oob_byte)   (((oob_byte)/UNIT_OOB_SIZE)-1)

#define NAND_NUM_OF_PAGE_PER_BLK(info)  ((info->_num_page_per_block+1) * UNIT_NUM_PAGE)
#define NAND_NUM_OF_BLOCK(info)         ((info->_num_block+1)* UNIT_NUM_BLK)
#define NAND_PAGE_SIZE(info)            ((info->_page_size+1) * UNIT_PAGE_SIZE)
#define NAND_SPARE_SIZE(info)           ((info->_spare_size+1) * UNIT_SPARE_SIZE)
#define NAND_OOB_SIZE(info)             ((info->_oob_size+1) * UNIT_OOB_SIZE)
