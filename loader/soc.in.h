...
typedef struct {
    ...
    union {
        ...
        plr_nor_spi_info_t      *nor_spi_info;
    } flash_info;
...
// edfine the group of nor spi drivers
#define SGID_NOR_SPI             'O'
    #define SCID_NOR_SPIF_COMMON 1
        #define SP_NOR_SPIF_INFO symb_dot_key(SGID_NOR_SPI, SCID_NOR_SPIF_COMMON, 0x10, 0)
