...
#ifdef _USE_DMEM
	/* Map 0xa0000000 (24K) to SRAM segment 1~3 for CPU Dram calibration*/
	SRAM_Map 0x00008000, 0x6, 0x10, 0x2000	
	SRAM_Map 0x0000a000, 0x6, 0x20, 0x4000	
	SRAM_Map 0x0000c000, 0x6, 0x30, 0x6000	
	/* Map 0xa8000000 (8K) to SRAM segment 0 for booting DSP (MIPS) */
	SRAM_Map 0x08000000, 0x6, 0x00, 0x0
#ifdef CONFIG_BOOT_MIPS
	DSP_SRAM_Map 0x9fc00000, 0x6, 0x00, 0x0	
#endif

	/* Clear SRAM */
	Mem_Set_Word 0xa0008000,0x6000,0x0  
	Mem_Set_Word 0xa8000000,0x2000,0x0  
#endif	
...
#ifdef CONFIG_BOOT_MIPS		
	/*booting MIPS*/
	/* copy instructions to 0xa8000000 for MIPS booting*/
        // la      t0, DSP_romInit
        la	t0, 0xbfc20000	
        addi    t1, t0, 0x1400
        li      t2, 0xa8000000
1:      lw      t3, 0(t0)
	...
	/* jump to boot up cpu1*/
	la	t0, boot_cpu1
	jal	t0
	nop

	la	t0, ipc_cpu_client
	jal	t0
	nop
#endif
...
COPY_NAND:
	...
	/*we don't jump to beginning here*/
#if 0	
	la		t0, MEM_START
	jr		t0
	nop
