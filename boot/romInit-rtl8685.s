...
#if 0	/* Open this code if need to turn off SWLED2 */
	/* turn off SWLED2(GPIO_E1) */
	li		t0, 0xb8000108
	lw		t1, 0(t0)
	nop
	li		t2, 0xfffffffb
...
DMEM_SETTING:
	...
	##################################################
	##		Set Bonding registers  
	##################################################	
	li		t0, 0xb8000100
	lw		t1, 0(t0)
	nop
	and		t1, t1, 0x04000000
	bnez	t1, is_bond
...
is_bond:	
	##################################################
	##	IC version detection !!
	##################################################
	li		t0, 0xb8000000
	lw		t1, 0(t0)
	nop
	and		t1, t1, 0x00020000  /* RL6318: 0x000e0561, RL6318B: 000c0561 */
	beqz		t1, is_6318B	
	
	##################################################
	##	Patch for GPHY in RL6318 !!
	##################################################
	li		t0, 0x841f0bcd
	li		t1, 0xbb804004
	sw		t0, 0(t1)
...
SPIandNOR:	
	...
	/* Clear SRAM */
	Mem_Set_Word 0xa0000000,0x4000,0x0  
